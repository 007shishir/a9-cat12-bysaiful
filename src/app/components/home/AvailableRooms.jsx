...
const AvailableRooms = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      {/* Dynamic Aesthetic Page Header Section */}
      <div className="border-b border-base-content/10 pb-5 mb-10 text-center sm:text-left">
        <h2 className="text-3xl font-black tracking-tight text-base-content mb-1.5">
          Available Rooms
        </h2>
        <p className="text-sm text-base-content/60 font-medium">
          Select and lock down a premium local workspace tailored for your productive focus goals.
        </p>
      </div>
      ...
      {!isLoading && rooms.length === 0 && (
        <div className="w-full bg-base-200/40 border border-dashed border-base-content/20 rounded-3xl p-10 text-center max-w-xl mx-auto my-6">
